    ...
    >
      <div className="flex flex-col gap-[1.125rem] items-center">
        ...
        <p className="text-primaryColor font-semibold text-[0.938rem] text-center w-4/5">
          Explore the beauty of various cities, their culture, and their
            ...
            {index % 2 === 0 ? (
              <>
                ...
                <div className="flex flex-col gap-6 justify-center">
                  <h1 className="text-primaryColor font-bold text-[2rem]">
                    {city.city}
                  </h1>
                  ...
                  <Link
                    to={`/details/place/${city.city}`}
                    className={buttonVariants({ variant: "default2" })}
                  >
                    Start Discovering
                  </Link>
                </div>
